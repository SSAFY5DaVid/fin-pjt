  ...
  <div class="d-flex flex-wrap" v-if="movieList">
    ...
    >
      <div  @click="goDetail(li.id)" v-if="li">
        ...
        <b-img class="rounded d-flex justify-content-center" style="width:125px; height:180px;" v-if="li.poster_path" fluid :src="image(li.poster_path)" alt="Image 2"></b-img>
        <b-img class="rounded d-flex justify-content-center" style="width:125px; height:180px;" v-else fluid :src="noImage" alt="Image 2"></b-img>
